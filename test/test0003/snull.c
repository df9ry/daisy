...
/*
 * Note: This code does not longer work, because of the modification
 * of the header is no longer possible in recent kernels.
 * The code shall compile, however without trouble.
 */
...
static const struct header_ops snull_header_ops = {
    .create  = snull_header,
    /**
     * This feature is not longer available.
